    ...
    <div>
      <div className="flex flex-col gap-3">
        <img
          ...
          src="https://www.infobae.com/new-resizer/rxHVEte6mUhroD2hSfpeJW9ZEXM=/filters:format(webp):quality(85)/cloudfront-us-east-1.images.arcpublishing.com/infobae/YABJ7CAXOZDVHAXSDRSQQ7NJR4.jpg"
        />
        <div className="text-left relative">
          ...
          <div>
            <div className="text-4xl font-bold py-5">League Of Legends</div>
